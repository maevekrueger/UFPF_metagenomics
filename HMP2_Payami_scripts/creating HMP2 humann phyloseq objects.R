...
# ------------------------------------------------------------------------------
# this is for the KO group data which we ended up not using for this analysis 
#but is available to use for future analyses
...
# save object 
saveRDS(humann_phyloseq_object, "HMP2_Payami/Phyloseq Objects/HMP2 IBD KO groups phyloseq object.rds")
