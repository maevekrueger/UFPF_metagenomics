library(readxl)
# reading in Payami functional KO group data 
...
Metadata <- readRDS("HMP2_Payami/Payami PD Metadata.rds")
...
# save object 
saveRDS(humann_phyloseq_object, "HMP2_Payami/Phyloseq Objects/KO groups phyloseq object.rds")
...
# save object 
saveRDS(humann_phyloseq_object2, "HMP2_Payami/Phyloseq Objects/Metacyc pathways phyloseq object.rds")
